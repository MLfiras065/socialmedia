...
function PostCard({ post }) {
  ...
  const updatePost = (id, postText, postImage) => {
    axios
      .put(`http://192.168.101.11:3000/api/post/upda/${id}`, {
        id,
        postText: postText,
        postImage,
      })
  ...
  const deletePost = (id) => {
    axios
      .delete(`http://192.168.101.11:3000/api/post/del/${id}`)
      .then((res) => {
        console.log("hi");
      })
      .catch((err) => {
